...
public class Danhhieu_level1 extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    default:
      return;
    case 10:
      this.tvthongbao.setText(getResources().getString(R.string.lv_question10));
      this.tvdanhhieu.setText(getResources().getString(R.string.troll_lv1));
    ...
    case 20:
      ...
      this.tvdanhhieu.setText(getResources().getString(R.string.troll_lv2));
      this.imTroll.setImageResource(R.drawable.trolltapsu);
      playButton(1);
      return;
    case 50:
		this.tvthongbao.setText(getResources().getString(R.string.lv_question50));
		this.tvdanhhieu.setText(getResources().getString(R.string.troll_lv3));
